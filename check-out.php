...
$rowsobat = query("SELECT * FROM keranjang");
...
<body>
    ...
    <section class="cart-total-page spad">
        <div class="container">
            <form action="pembayaran.php" class="checkout-form" method="post">
                <div class="row">
                    <div class="col-lg-12">
                    ...
                    <div class="col-lg-3">
                        <div class="order-table">
                            <?php foreach ($rowsobat as $index => $rowobat): ?>
                            <div class="cart-item">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <span>Product</span>
                                        <p class="product-name"><?php echo $rowobat['nama_produk']; ?></p>
                                    </div>
                                    <div>
                                        <span>Price</span>
                                        <p>$<?php echo $rowobat['harga']?></p>
                                    </div>
                                </div>
                                <div>
                                    <span>Quantity</span>
                                    <p><?php echo $rowobat['quantity'] ?></p>
                                </div>
                            </div>
                            <?php endforeach; ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="payment-method">
                            ...
                            <button type="submit" name="pesan">Place your order</button>
                        </div>
                    </div>
                </div>
            </form>
