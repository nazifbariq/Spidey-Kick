    ...
    <header class="header-section">
        <div class="container-fluid">
            <div class="inner-header">
                <div class="logo">
                    <a href="./index.html"><img src="img/logo.png" alt="" width="150" ></a>
                </div>
                    ...
                    <ul>
                        ...
                        <li><a href="./categories.html">Shop</a>
                            <ul class="sub-menu">
                                ...
                                <li><a href="login.php">Shopping Card</a></li>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="header-item">
                        ...
                        <p>Gratis Ongkir Seluruh Jawa</p>
                    </div>
                </div>
                <div class="col-md-4 text-left text-lg-center">
                    <div class="header-item">
                        <img src="img/icons/voucher.png" alt="">
                        <p>20% DIskon Untuk Pelajar</p>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1>2023</h1>
                            <h2>SneakersHead.</h2>
                            <a href="#" class="primary-btn">Lihat Disini</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="single-features-ads first">
                            ...
                            <h4>Free shipping</h4>
                            <p>Spidey.Kick Akan menjamin pengiriman sneakers anda.Jika ada Kendala anda dapat menghubungu Cusmer Service agar keluhan anda tersampaikan. Serta anda bisa mengetahui sneakers anda sudah sampai mana pengirimanya. </p>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="single-features-ads second">
                            ...
                            <p>Spidey.Kick akan menjamin uang kembali jika sneakers tidak berkualitas original. Dengan syarat dan ketentuan yang telah dibuat.</p>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="single-features-ads">
                            ...
                            <p>Spidey.Kick siap melayani berbagai keluhan atau saran melalui customer service yang aktif dalam waktu 24 jam. </p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="single-box-item first-box">
                                    ...
                                    <div class="box-text">
                                        <span class="trend-year">2023 Sneakers</span>
                                        <h2>J</h2>
            ...
            <div class="row">
                <div class="col-lg-4 offset-lg-1">
                    <div class="lookbok-left">
                        <div class="section-title">
                            <h2>2023 <br />#HypeBeast</h2>
                        </div>
                        <p>"Hypebeast" adalah istilah yang digunakan untuk menggambarkan seseorang yang selalu mengikuti tren terbaru dalam mode dan fashion, terutama dengan membeli produk-produk yang populer dan "hype" (ramai diperbincangkan) pada saat itu. Istilah ini bisa memiliki konotasi positif atau negatif, tergantung pada sudut pandang dan niat individu yang menggunakan istilah tersebut. Di bawah ini adalah beberapa kata-kata atau kalimat yang terkait dengan "hypebeast":</p>
                        <a href="#" class="primary-btn look-btn">lihat Lainya</a>
                    </div>
                </div>
